...
export const title = 'Deploy a Gatsby.js App to Gatsby Edge Network'
export const description = 
  'Deploy a Gatsby.js app with an encrypted .env.vault file to Gatsby Edge.'

<FrameworksBreadcrumb framework='Gatsby.js' url='/docs/frameworks/gatsby' />
<GuideHeading
  h1={title}
  icon={<GatsbyIcon className="h-9 w-9 text-[#663399]"/>} />
