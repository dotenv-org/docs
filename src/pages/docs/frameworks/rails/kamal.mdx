...
Then modify your `.env` file, setting your `KAMAL_REGISTRY_PASSWORD` to your docker registry's password and your `RAILS_MASTER_KEY`.
...
Also, modify `config/environments/production.rb` to permit standard http for now.
