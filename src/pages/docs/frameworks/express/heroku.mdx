...
export const title = 'Deploy an Express.js App to Heroku'
export const description =
  'Deploy an Express.js app with an encrypted .env.vault file to Heroku.'

<FrameworksBreadcrumb framework='Express.js' url='/docs/frameworks/express' />
<GuideHeading
  h1={title}
  lead={description}
  icon={
...
<Note>
  Find a complete <a href="https://github.com/dotenv-org/examples/tree/master/express/heroku">code example on GitHub</a> for this guide.
</Note>
