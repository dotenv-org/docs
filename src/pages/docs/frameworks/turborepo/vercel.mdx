...
Your first deploy will likely fail because you need to configure the root directory on Vercel's UI. Go to project settings and set the root directory to `apps/web`.
