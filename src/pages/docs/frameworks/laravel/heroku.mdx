...
<FrameworksBreadcrumb framework='Laravel' url='/docs/frameworks/rails' icon={
  <>
...
Use the UI to configure those secrets per environment. Make sure you set both the `HELLO` and `DUDE`.
