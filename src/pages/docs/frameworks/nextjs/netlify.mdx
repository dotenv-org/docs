...
export const title = 'Deploy a Next.js App to Netlify'
export const description = 
  'Deploy a Next.js app with an encrypted .env.vault file to Netlify.'

<FrameworksBreadcrumb framework='Next.js' url='/docs/frameworks/nextjs' />
<GuideHeading
  h1={title}
  lead={description}
  icon={
...
<Note>
  Find a complete <a href="https://github.com/dotenv-org/examples/tree/master/nodejs/netlify">code example on GitHub</a> for this guide.
</Note>
