...
export const title = 'Deploy a Remix.js App to Vercel'
export const description = 
  'Deploy a Remix.js app with an encrypted .env.vault file to Vercel.'

<FrameworksBreadcrumb framework='Remix.js' url='/docs/frameworks/remix' />
<GuideHeading
  h1={title}
  lead={description}
  icon={
...
<Note>
  Find a complete <a href="https://github.com/dotenv-org/examples/tree/master/remix/vercel">code example on GitHub</a> for this guide.
</Note>
