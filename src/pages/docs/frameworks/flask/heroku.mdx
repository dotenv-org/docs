...
export const title = 'Deploy a Flask App to Heroku'
export const description =
  'Deploy a Flask app with an encrypted .env.vault file to Heroku.'

<FrameworksBreadcrumb framework='Flask' url='/docs/frameworks/flask' />
<GuideHeading
  h1={title}
  lead={description}
  icon={
...
<Note>
  Find a complete <a href="https://github.com/dotenv-org/examples/tree/master/flask/heroku">code example on GitHub</a> for this guide.
</Note>

## Initial setup

Install [flask](https://github.com/pallets/flask) and [gunicorn](https://github.com/benoitc/gunicorn).
...
<ScreenshotBrowser url="/assets/img/docs/hello-none.png" www="yourapp.herokuapp.com" />
...
That's it! On deploy, your `.env.vault` file will be decrypted and its production secrets injected as environment variables – just in time.
