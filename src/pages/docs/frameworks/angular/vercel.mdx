...
export const description = 
  'Deploy an Angular.js app with an encrypted .env.vault file to Vercel.'

<FrameworksBreadcrumb framework='Angular.js' url='/docs/frameworks/angular' icon={
  <>
    <AngularIcon className="h-9 w-9 text-[#DD0031]"/>
    <VercelIcon className="h-9 w-9 text-[#000000] dark:invert"/>
  </>
} />
# Deploy a Angular.js App to Vercel
...
Create an Angular.js application.
...
Preload Angular.js scripts using dotenv. This will inject environment variables ahead of Angular.js.
