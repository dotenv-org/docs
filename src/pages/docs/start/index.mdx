...
export const description =
  'Copy-and-paste guides for mastering .env and .env.vault files'

export const sections = [
  { title: 'Languages', id: 'languages' },
  { title: 'Deploying', id: 'deploying' },
  { title: 'CI/CD', id: 'cis' },
...
You can jump straight into a quickstart example using Node.js and Heroku or scroll below for tailored guides per language, platform, and framework.
