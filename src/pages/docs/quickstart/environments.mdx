...
Solid! You completed this quickstart guide – managing your secrets across multiple environments. I recommend learning how to [add teammates](/docs/quickstart/team).

* [Add teammates](/docs/tutorials/teammates) to your projects
* [Load `.env` files](/docs/quickstart/load) in development
* [Deploy `.env.vault` files](/docs/quickstart/load) in production, staging, and ci environments
