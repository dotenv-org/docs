  ...
  <div className="not-prose mt-4 grid grid-cols-1 gap-x-6 gap-y-10 border-t border-zinc-900/5 pt-10 dark:border-white/5 sm:grid-cols-2 xl:max-w-none xl:grid-cols-3">
    ...
    <div key="python" className="flex flex-row-reverse gap-6">
      <div className="flex-auto">
        ...
        <p className="mt-4"><Button href="/docs/languages/python" variant="text" arrow="right">Start</Button></p>
      </div>
    ...
    <div key="ruby" className="flex flex-row-reverse gap-6">
      <div className="flex-auto">
        ...
        <p className="mt-4"><Button href="/docs/languages/ruby" variant="text" arrow="right">Start</Button></p>
      </div>
    ...
    <div key="php" className="flex flex-row-reverse gap-6">
      <div className="flex-auto">
        ...
        <p className="mt-4"><Button href="/docs/languages/php" variant="text" arrow="right">Start</Button></p>
      </div>
    ...
    <div key="go" className="flex flex-row-reverse gap-6">
      <div className="flex-auto">
        ...
        <p className="mt-4"><Button href="/docs/languages/go" variant="text" arrow="right">Start</Button></p>
      </div>
