export const description = 
  'Load environment variables from encrypted .env.vault files, with Golang 🐹.'

##### Language Guides
# Go

ⓘ This guide assumes you are already familiar with <a href="https://github.com/joho/godotenv">godotenv</a>. It extends it with <a href="https://github.com/dotenv-org/godotenvvault">godotenvvault</a>.
