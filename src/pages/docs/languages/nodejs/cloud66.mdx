...
Once deployed, your app will say `'Hello undefined'` at [localhost:3000](http://localhost:3000) as it doesn’t have a way to access the environment variable yet. Let’s do that next.
