...
<Note>
  Find a complete <a href="https://github.com/dotenv-org/examples/tree/master/nodejs/bitbucket">code example on GitHub</a> for this guide.
</Note>
...
Commit that to code and push to Bitbucket.

<ScreenshotBrowser url='/assets/img/docs/bitbucket-hello-undefined.png' www='bitbucket.org/org/app/pipelines' />

Once pushed, the Bitbucket pipeline build will say `'Hello undefined'` as it doesn't have a way to access the environment variable yet. Let's do that next.
...
Set `DOTENV_KEY` on Bitbucket.

<ScreenshotBrowser url='/assets/img/docs/bitbucket-config-vars.gif' www='bitbucket.org' />
...
<ScreenshotBrowser url='/assets/img/docs/bitbucket-logs-vault.png' www='bitbucket.org' />
