...
export const title = 'Deploy a Node.js App to Railway'
export const description = 
  'Deploy a Node.js app with an encrypted .env.vault file to Railway.'
...
<Note>
  Find a complete <a href="https://github.com/dotenv-org/examples/tree/master/nodejs/railway">code example on GitHub</a> for this guide.
</Note>
...
<ScreenshotBrowser url='/assets/img/docs/hello-undefined.png' />
...
<ScreenshotBrowser url="/assets/img/cloudinary/integrations-railway-nodejs_rwo40w.gif" www="railway.com" />
...
<ScreenshotBrowser url="/assets/img/docs/railway-logs-vault.png" www="npx @railway/cli@latest logs" />
