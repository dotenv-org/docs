export const description = 
  'Load environment variables from encrypted .env.vault files, with Python 🐍.'

##### Language Guides
# Python

ⓘ This guide assumes you are already familiar with <a href="https://github.com/theskumar/python-dotenv">python-dotenv</a>. It extends it with <a href="https://github.com/dotenv-org/python-dotenv-vault">python-dotenv-vault</a>.
